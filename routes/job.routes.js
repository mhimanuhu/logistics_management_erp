...
router.get("/:id/export/phase/3", authMiddleware, upload.single("image"), exportPhase.getExportPhase3);
router.put("/:id/export/phase/3", authMiddleware, upload.single("image"), exportPhase.updateExportPhase3);
...
router.put("/:id/import/phase/1", authMiddleware, upload.single("image"), importPhase.updateImportPhase1);
...
router.put("/:id/import/phase/2", authMiddleware, upload.single("image"), importPhase.updateImportPhase2);
